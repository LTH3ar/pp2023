...
class Output:
    ...
    def List2FilePickle(self, filename, lst): #write to json file
        with open(filename, "wb") as file:
            pickle.dump(lst, file)

    def export_data_pickle(self):
        filename1 = "students_data.dt"
        filename2 = "courses_data.dt"
        filename3 = "marks_data.dt"
        self.List2FilePickle(filename1, self.__student_list)
        self.List2FilePickle(filename2, self.__course_list)
        self.List2FilePickle(filename3, self.__mark_list)