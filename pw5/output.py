...
class Output:
    ...
    def compress_data(self, filename, src): # compress json file
    ...
    def export_data(self):
        ...
        src = [filename1, filename2, filename3]
        ...
        self.compress_data("students.dat", src)
        for i in src:
            os.remove(i)
    ...
    def export_data_daemon(self):
        while True:
            ...
            time.sleep(1)
            filename1 = "students_data_tmp.json"
            filename2 = "courses_data_tmp.json"
            filename3 = "marks_data_tmp.json"
            self.List2File(filename1, self.__student_list)
            self.List2File(filename2, self.__course_list)
            self.List2File(filename3, self.__mark_list)
    ...
    def export_data_rename(self):
        ...
        filename2 = "courses_data_tmp.json"
        filename3 = "marks_data_tmp.json"
        os.rename(filename1, "students_data.json")
        os.rename(filename2, "courses_data.json")
        os.rename(filename3, "marks_data.json")
        src = ["students_data.json", "courses_data.json", "marks_data.json"]
        self.compress_data("students.dat", src)
        for i in src:
            os.remove(i)
        self.stdscr.addstr(0, 0, "Exported successfully!")
